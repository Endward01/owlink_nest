...
div.classList.add("flex", "justify-between", "grow", "container", "mx-auto", "overflow-hidden", "flex", "flex-col", "relative", "shadow-(--box-shadow-inset-main)", "rounded-lg", "my-2", "relative", "z-2", "text-[" + textColor + "]");
